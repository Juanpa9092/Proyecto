function consultarBicicletas() {
    $.ajax(
             {
                url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike',
                type         : 'GET',
                dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike/' + codigo ,
                    type         : 'GET',
                    dataType     : 'json',
...
function consultarClientes() {
    $.ajax(
             {
                url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client',
                type         : 'GET',
                dataType     : 'json',
                success      :  function(json){
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + codigo ,
                    type         : 'GET',
                    dataType     : 'json',
...
function consultarMensajes() {
    $.ajax(
             {
                url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message',
                type         : 'GET',
                dataType     : 'json',
                success      :  function(json){
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g5002a6f6d04197-dbreto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message/' + codigo ,
                    type         : 'GET',
                    dataType     : 'json',
